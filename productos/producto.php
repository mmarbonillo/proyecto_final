...
$query = mysqli_query($mysqli, "SELECT * FROM producto WHERE codigo = 1");
$fabris = mysqli_query($mysqli, "SELECT fabricante.nombre AS fabricante from fabricante, producto WHERE fabricante.codigo=codigo_fabricante AND codigo_fabricante=1");
